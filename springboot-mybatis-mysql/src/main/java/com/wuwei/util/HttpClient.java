...
public class HttpClient {
    ...
    private static final RequestConfig requestConfig = RequestConfig.custom().setSocketTimeout(200000).setConnectTimeout(200000).build();
     ...
     * @throws Exception 
     */
    public static String sendGetHasHeaderCooke(String url, Map<String, String> params, Map<String, String> headerMap) throws Exception {
    	disableSSLCertCheck();
    	 if (url == null || url.isEmpty()) {
             return "";
         }
         ...
         //设置请求响应配置
         httpGet.setConfig(requestConfig);
        // PIUnitUtil.disableSSLCertCheck();
         for (Map.Entry<String,String> entry : headerMap.entrySet()) { 
     		  System.out.println("Key = " + entry.getKey() + ", Value = " + entry.getValue()); 
     		  httpGet.setHeader(entry.getKey(), entry.getValue());
     		  //.append(new String(entry.getValue().getBytes("UTF-8"),"ISO8859-1")+"&");
     		}
         CloseableHttpResponse response = null ;
    ...
    * @throws Exception 
    */
   public static String sendPostHasHeaderCooke(String url, Map<String, String> params, Map<String, String> headerMap) throws Exception {
	   if (url == null || url.isEmpty() || params == null || params.isEmpty()) {
           return "";
       }
       String result = "";
